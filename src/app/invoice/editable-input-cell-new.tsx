...
export default forwardRef<InputCellHandler, Omit<React.ComponentProps<"input">, "ref"> & NewEditableCellProps>(
    function NewEditableInputCell({ initialValue, onValueAccepted, validate, formatter, ...props }, ref) {
