    ...
    return (
        <>
            <div data-component="overlay" className="fixed inset-0 z-50 pointer-events-none">
                <div onClick={openDialog} className="absolute hover:shadow-2xl flex vertical-text px-6 py-1 transition-all duration-200 top-1/4 pointer-events-auto rounded-r-2xl left-[-4px] transform -translate-y-1/2 cursor-pointer border border-gray-900 bg-[linear-gradient(to_top_left,_#111827,_#2C3444,_#111827,_#2C3444)]" >
